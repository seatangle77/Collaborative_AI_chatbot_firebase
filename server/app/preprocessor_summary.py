...
def extract_chunk_data(round_index: int, start_time: str, end_time: str, group_id: str, member_list: list) -> dict:
    """
    ...
    debug_file_path = f"debug_outputs/chunk_data_{uuid4().hex}.json"
...
def build_cognitive_input(chunk_data: dict) -> dict:
    """
...
def build_behavior_input(chunk_data: dict) -> dict:
    """
...
def build_attention_input(chunk_data: dict) -> dict:
    """
